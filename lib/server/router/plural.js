...
module.exports = (db, name, opts) => {
  ...
  function list(req, res, next) {
    ...
    Object.keys(req.query).forEach(query => {
      ...
      for (let i in arr) {
        if (_.has(arr[i], query) || query === 'callback' || query === '_' || /_|\.eq$/.test(query) || /_|\.ne$/.test(query) || /_|\.lt$/.test(query) || /_|\.gt$/.test(query) || /_|\.le$/.test(query) || /_|\.ge$/.test(query) || /_|\.lte$/.test(query) || /_|\.gte$/.test(query) || /_|\.like$/.test(query) || /_|\.null$/.test(query) || /_|\.empty$/.test(query) || /_|\.sort$/.test(query) || /_|\.join$/.test(query)) return;
      }
